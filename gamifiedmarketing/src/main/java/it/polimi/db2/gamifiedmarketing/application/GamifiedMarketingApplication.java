...
public class GamifiedMarketingApplication {
    ...
    public void init() throws SQLException, ClassNotFoundException {
        ...
        Submission sub_user2 = Submission.builder().expertiseLevel(ExpertiseLevel.HIGH).sex(Sex.FEMALE).submissionStatus(SubStatus.CONFIRMED).points(0).responses(new ArrayList<>()).build();
