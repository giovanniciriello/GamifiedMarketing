...
public class GamifiedMarketingApplication {
    ...
    public void init() {
        ...
        // --- Reviews --- \\
        Review review1 = Review.builder().text("First of all, I purchased this directly from Amazon. Look out for and you are guaranteed to receive a legitimate product. Other reviewers who are claiming that the product is counterfeit are probably purchasing from third party sellers.").build();
        Review review2 = Review.builder().text("I am someone who does not enjoy the in-ear style earbuds. The ones with rubber tips that you jam into your ear canals. They are usually uncomfortable and give me headaches. For this reason, I have stuck with the traditional EarPods and AirPods design..").build();
        Review review3 = Review.builder().text("i have found that after the airpod shows as being connected and is active on my Google Pixel, if I close the wireless case, the airpod is disconnected. Why is this happening? I thought this was compatible with Android..").build();
